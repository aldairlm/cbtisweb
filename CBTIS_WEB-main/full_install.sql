-- Full Installation Script for CBTIS 258 Website
-- Use this script in phpMyAdmin on AwardSpace

-- 1. Create Tables (Drop if they exist to start fresh)
...
-- News (With corrected image link for Feria)
